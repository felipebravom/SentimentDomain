 ...
 * More info about the task: https://www.cs.york.ac.uk/semeval-2013/task2/
...
public class SemEvalToArff extends TweetCollectionToArff {
	...
	public Instances createDataset(String collectionPath) throws Exception{
		...
		while( (line=bf.readLine())!=null){
			...
			else if(content.equals("neutral")||content.equals("objective")||content.equals("objective-OR-neutral"))
	   ...
	   *
	   * @param argv should contain the path of input dataset and the name of target file 
