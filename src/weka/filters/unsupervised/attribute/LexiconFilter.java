...
public class LexiconFilter extends SimpleBatchFilter {
	...
	protected Instances determineOutputFormat(Instances inputFormat)
		...
		att.add(new Attribute("LEX-NRC-emo-anticipation")); // NRC-emotion
															// anticipation
															// words
		att.add(new Attribute("LEX-NRC-emo-disgust")); // NRC-disgust disgust
														// words
		att.add(new Attribute("LEX-NRC-emo-fear")); // NRC-emotion fear words
		att.add(new Attribute("LEX-NRC-emo-joy")); // NRC-emotion joy words
		att.add(new Attribute("LEX-NRC-emo-sadness")); // NRC-emotion sadness
														// words
		att.add(new Attribute("LEX-NRC-emo-surprise")); // NRC-emotion surprise
														// words
		att.add(new Attribute("LEX-NRC-emo-trust")); // NRC-emotion trust
														// emotion words
	...
	protected Instances process(Instances instances) throws Exception {
		...
		for (int i = 0; i < instances.numInstances(); i++) {
			...
			Map<String, Integer> nrcEmoCounts = nrcEmoLex
