...
public class ClassifierPerCluster extends RandomizableSingleClassifierEnhancer {
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    if (clustererString.length() > 0) {
      ...
      clustererSpec[0] = "";
      setClusterer((Clusterer) Utils.forName(Clusterer.class, clustererName, clustererSpec));
    } else {
  ...
  public double[] distributionForInstance(Instance instance) throws Exception {
    ...
    return m_Classifiers[m_Clusterer.clusterInstance(newInst)].distributionForInstance(instance);
  }
  ...
  public Capabilities getCapabilities() {
    ...
    Capabilities result = (Capabilities) m_Clusterer.getCapabilities().clone();
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    if (m_Clusterer instanceof Randomizable) {
      ...
      if (m_Debug) {
        System.err.println("Clusterer does not implement Randomizable.");
      }
    }
    ...
    Instances[] perClusterData = new Instances[m_Clusterer.numberOfClusters()];
    ...
    m_Classifiers = AbstractClassifier.makeCopies(m_Classifier, perClusterData.length);
    for (int i = 0; i < perClusterData.length; i++) {
